...
function openapiSpec() {
  ...
  return {
    ...
    info: {
      ...
      version: VERSION,
      description: "Deterministic linguistic mediation. Peer renders, not a translator. " + MOTTO + " Suite mesh /v1/mesh/* PROXY to aziel-runtime (AZIEL_RUNTIME). Default OFF. QNM-BUILD-1.0 live|locked|isolated. QNS-CD-1.0 photon QNS1 hub cite (no public qnsd proxy). No Node Gate. No auto-heal. Not anonymity. Aziel Eliab only.",
    },
    servers: [{ url: HOST }],
    paths: {
...
<title>Glossa Filter — use with AI assistants — Aziel Eliab</title>
<style>
...
<body>
  ...
  <p>Suite mesh: <code>GET ${HOST}/v1/mesh</code> PROXY to aziel-runtime. Default OFF. QNM-BUILD-1.0 live|locked|isolated. QNS-CD-1.0 photon QNS1 packet transfer is a hub cite / Worker mesh cross-map only (local qnsd in <a href="https://github.com/AzielEliab/qnm-node">qnm-node</a>; runtime cites in <a href="https://github.com/AzielEliab/aziel-runtime">aziel-runtime</a>). Not a Softwares-tab product. No Node Gate. No public qnsd proxy. No auto-heal. Not anonymity. Author: Aziel Eliab only.</p>
