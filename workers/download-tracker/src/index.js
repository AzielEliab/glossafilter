...
<body>
  <h1>Glossa Filter</h1>
  <p class="motto">Human opinion remains human, and tools remain tools.</p>
  <div class="card">
    <p class="count">${n}<span> downloads of this project</span></p>
    <a class="dl" href="/download?asset=glossafilter-0.1.0.tar.gz">Download glossafilter-0.1.0.tar.gz — ${n} counted</a>
    ...
    <p class="iso">Isolated counter: Worker <code>glossafilter-download-tracker</code>, project <code>glossafilter</code>. Not mixed with any other product.</p>
